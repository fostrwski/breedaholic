...
const ClearFiltersButton: React.FC<ClearFiltersButtonProps> = ({
  ...
  return (
    <Button
      customClasses={`text-red-600 bg-transparent rounded-full focus-visible:bg-red-50 focus-visible:brightness-100 justify-center flex items-center gap-2 ${customClasses}`}
      onClick={handleClick}
    >
