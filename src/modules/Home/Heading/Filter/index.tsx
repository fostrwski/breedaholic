...
const Filter: React.FC = () => {
  ...
  return (
    <Popover>
      ...
      <Popover.Panel className="absolute inset-x-0 z-[100] mt-4 rounded-lg bg-white p-6 shadow-2xl shadow-gray-400 md:inset-x-auto md:right-6 md:w-96 lg:right-28">
        <>
          <Name />
